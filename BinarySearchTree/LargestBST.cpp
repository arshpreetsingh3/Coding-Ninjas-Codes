...
Node<int>* constructBST(BinaryTreeNode<int>* root){
    ...
    head = constructBST(root->left);
    Node<int>* temp = head;
    Node<int>* rootofll = new Node<int>(root->data);
    head2 = constructBST(root->right);
    if(temp!=NULL){
...
void insertDuplicateNodeSol(BinaryTreeNode<int>* root){
    if(root == NULL){
        return;
    }
    ...
    insertDuplicateNodeSol(rootLeft);
    insertDuplicateNodeSol(root->right);
}
...
BinaryTreeNode<int>* lcaBT(BinaryTreeNode<int>* root,int val1,int val2){
    if(root == NULL){
        return NULL;
    }
    ...
    BinaryTreeNode<int>* leftlca = lcaBT(root->left,val1,val2);
    BinaryTreeNode<int>* rightlca = lcaBT(root->right,val1,val2);
...
int lcaBinaryTree(BinaryTreeNode<int>* root,int val1,int val2){
    BinaryTreeNode<int>* result = lcaBT(root,val1,val2);
    if(result == NULL){
        return -1;
    }else{
        return result->data;
...
BinaryTreeNode<int>* lcaBST(BinaryTreeNode<int>* root,int val1,int val2){
    if(root == NULL){
        return NULL;
    }
    if(root->data==val1 || root->data==val2){
    ...
    BinaryTreeNode<int>* leftlca = lcaBST(root->left,val1,val2);
    BinaryTreeNode<int>* rightlca = lcaBST(root->right,val1,val2);
    if(leftlca!=NULL && rightlca!=NULL){
        return root;
    }
    else if(leftlca==NULL){
...
int lcaInBST(BinaryTreeNode<int>* root,int val1,int val2){
    BinaryTreeNode<int>* result = lcaBST(root,val1,val2);
    if(result == NULL){
        return -1;
    }else{
        return result->data;
...
bstSubtreeReturn largestBSTSol(BinaryTreeNode<int>* root){
    if(root == NULL){
    ...
    bstSubtreeReturn left = largestBSTSol(root->left);
    bstSubtreeReturn right = largestBSTSol(root->right);
...
int largestBSTSubtreesol(BinaryTreeNode<int> * root){
    return largestBSTSol(root).height;
}
...
int main() {
   ...
   */
  cout<<endl;
 //Node<int>* ans = constructBST(root);
 //print(ans);
 ...
 */
//nodeSumToS(root,8);
cout<<"height of largest subtree using cn sol"<<largestBSTSubtreesol(root)<<endl;
cout<<"height of largest subtree"<<largestBSTSubtree(root)<<endl;
}
